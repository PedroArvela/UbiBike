...
public class MsgSenderActivity extends Activity implements
    ...
    private OnClickListener listenerSendButton = new OnClickListener() {
        @Override
        public void onClick(View v) {
            findViewById(R.id.SubmitMsg).setEnabled(false);
	...
	public class OutgoingCommTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			if (result != null) {
				...
				Log.d("hi", "this is outgoing");
                findViewById(R.id.SubmitMsg).setEnabled(true);
                mTextInput.setHint("");
                mTextInput.setText("");
                mTextOutput.setText("");
            }
	...
	private void guiSetButtonListeners() {
		findViewById(R.id.SubmitMsg).setOnClickListener(listenerSendButton);
	}

	private void guiUpdateInitState() {
		
		mTextInput = (TextView) findViewById(R.id.new_sms);
