...
public class CancelBikeReservationTask extends AsyncTask<Station, Boolean, Boolean> {
    App app;
    Handler handler;
    Resources resources;
    ...
    public CancelBikeReservationTask(App app, Handler handler, Resources resources) {
        this.app = app;
    ...
    protected Boolean doInBackground(Station... params) {
        ...
        try {
            ...
            Pair<Integer, List<String>> response = url.fetchUrl("station/" + station.getName() + "/cancel");
            ...
            Log.e("CancelBikeReserveTask", e.getMessage());
            e.printStackTrace();
        } finally {
            return result;
        }
