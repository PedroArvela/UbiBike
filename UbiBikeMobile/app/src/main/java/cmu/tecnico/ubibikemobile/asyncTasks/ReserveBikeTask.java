...
public class ReserveBikeTask extends AsyncTask<Station, Boolean, Boolean> {
    ...
    public ReserveBikeTask(App app, Handler handler, Resources resources) {
        this.app = app;
    ...
    protected Boolean doInBackground(Station... params) {
        ...
        try {
            ...
            Pair<Integer, List<String>> response = url.fetchUrl("station/" + station.getName() + "/reserve");
            ...
            Log.e("ReserveBikeTask", e.getMessage());
            e.printStackTrace();
        } finally {
            return result;
        }
